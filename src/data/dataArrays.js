export const categories = [
  {
    ...
    name: 'Staple Foods',
    photo_url:
    'https://pbs.twimg.com/media/EvkIO7UXYAAWHdD?format=jpg&name=medium'
  },
  {
    id: 1,
    name: 'Soups and Stews',
    photo_url: 'https://www.eatingwell.com/thmb/HoFRehpKcSgors_7U78VrV4jalI=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/5557027-8401cb2a3c4f47af93ba0d3e9386ca70.jpg'
  },
  {
    id: 2,
    name: 'Rice Dishes',
    photo_url:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Plates_of_Jollof_Rice%2C_Fried_Rice_and_Chicken.jpg/798px-Plates_of_Jollof_Rice%2C_Fried_Rice_and_Chicken.jpg?20210223142219'
  },
  {
    id: 4,
    name: 'Snacks',
...
export const recipes = [
  {
    ...
    categoryId: 3,
    title: 'Fufu',
    photo_url: 'https://miro.medium.com/v2/resize:fit:786/format:webp/1*XDjyQ6dBVMdybEySuQlHGw.jpeg',
    photosArray: [
      'https://miro.medium.com/v2/resize:fit:786/format:webp/1*XDjyQ6dBVMdybEySuQlHGw.jpeg',
      'https://agameals.com/wp-content/uploads/2022/03/maxresdefault-16-1140x694.jpg'
    ],
    time: '45',
    ingredients: [[18, '200ml'], [5, '5g'], ['Large Cassava', '300g']],
    description:
      '-- Peel and Cut the Cassava: Start by peeling the cassava root with a sharp knife. Cut it into chunks to make it easier to handle during the cooking process.\n\n -- Boil the Cassava: In a large pot, add enough water to cover the cassava chunks. Bring the water to a boil and add the cassava. Cook the cassava until it becomes soft and fork-tender. This usually takes about 20-30 minutes. \n\n -- Drain and Cool: Once the cassava is fully cooked, drain the water and let the cassava cool for a few minutes until it is safe to handle. \n\n -- Pound the Cassava: Traditionally, fufu is made by pounding the cooked cassava using a large mortar and pestle. However, you can also use a fufu machine or an electric mixer with a dough hook attachment to pound the cassava. If using a mixer, cut the cassava into smaller pieces and mix at low speed until it forms a smooth and stretchy dough.\n\n -- Shape the Fufu: If you are using a mortar and pestle, pound the cassava until it becomes smooth and stretchy. Wet your hands with water to prevent sticking and shape the pounded cassava into round or oval-shaped balls. \n\n -- Serve: Fufu is usually served with various soups and stews. It is commonly enjoyed with soups like Groundnut Soup or Light Soup, and stews like Palm Nut Soup. To eat fufu, tear off a small piece with your fingers, use it to scoop up the soup or stew, and enjoy!'
  },
  {
    recipeId: 3,
    categoryId: 4,
  ...
  },
  {
    ...
    categoryId: 3,
    title: 'Banku',
    photo_url: 'https://conniesrestaurant.uk/wp-content/uploads/2023/03/Banku-830x552.jpg',
    photosArray: [
      'https://conniesrestaurant.uk/wp-content/uploads/2023/03/Banku-830x552.jpg',
      'https://www.196flavors.com/wp-content/uploads/2019/06/banku-5.jpg',
    ],
    time: '30',
    ingredients: [
      [0, '2 quarts'],
  ...
  },
  {
    ...
    title: 'Kenkey',
    photo_url:
      'https://tapolifood.com/wp-content/uploads/2020/09/20200915_161534.jpg',
    photosArray: [
      'https://tapolifood.com/wp-content/uploads/2020/09/20200915_161534.jpg',
      'https://cdn.modernghana.com/content/300/360/1129201755553_kenkey1.jpg',
    ],
    time: '45',
    ingredients: [
      [0, '2 tablespoons'],
